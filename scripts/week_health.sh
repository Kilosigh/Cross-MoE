...
all_models=("Informer" "Reformer" "PatchTST")
start_index=$1
end_index=$2
models=("${all_models[@]:$start_index:$end_index-$start_index+1}")
root_paths=("./data/Public_Health" "./data/Algriculture" "./data/Climate" "./data/Economy" "./data/Energy" "./data/Environment" "./data/Security" "./data/SocialGood" "./data/Traffic")
data_paths=("US_FLURATIO_Week.csv" "US_RetailBroilerComposite_Month.csv" "US_precipitation_month.csv" "US_TradeBalance_Month.csv" "US_GasolinePrice_Week.csv" "NewYork_AQI_Day.csv" "US_FEMAGrant_Month.csv" "Unadj_UnemploymentRate_ALL_processed.csv" "US_VMT_Month.csv") 

time_granularity_type=(1 0 0 0 1 2 0 0 0)
