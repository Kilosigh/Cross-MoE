...
all_models=("Informer" "Reformer" "PatchTST" "iTransformer" "TimeLLM" "Nonstationary_Transformer" "TimeXer" "TimesNet" "TimeLLM")
start_index=$1
end_index=$2
use_uni=0
    ...
    do
      ...
      do
        ...
        python -u run.py \
          ...
          --prompt_weight 0.1 \
          --pool_type "avg" \
          --save_name "result_health_bert_$dataset_idx" \
          --llm_model BERT \
